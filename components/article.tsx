...
export const Article = ({img, name, tags, description, liveURL, githubURL, articleURL, tech, children}) => {
    ...
    <Card className="w-[960px] space-y-5 p-6" radius="lg">
      ...
      <CardBody className="overflow-visible py-0 px-2 flex-column">
        <div className="pt-4 flex-row">
          I first stumbled upon saltybet during my time at CodeCore Bootcamp in Vancouver, BC in 2017. It was a simple distraction that I would turn my attention to while waiting for bundler to fetch rubygems (particulary nokogiri at the time), or just to take a break from digesting the algorithm lesson of the day. Suffice to say, in spite of the mild enjoyment of making a wager on what was essentially a coin-toss, I didn't have the bandwidth to memorize the sheer volume of combinations of fighter attributes and statistics. The obvious solution was to create Saltybot.
<br /><br /><ArticleImage
